...
func (cs *ControllerServer) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse, error) {
	...
	klog.V(4).Infof("CreateVolume: %v", name)
	...
	sealfsVol, err := cs.cli.Create(volumeName, server, reqCapacity, onDelete)
	if err != nil {
...
// newSealfsVolume Convert VolumeCreate parameters to an nfsVolume
// func newSealfsVolume(name string, size int64, params map[string]string, defaultOnDeletePolicy string) (*sealfsVolume, error) {
// 	// format volume name by params[pvNameKey]
// 	volumeName := name
// 	if volumeName == "" {
// 		return nil, fmt.Errorf("missing required volume name")
// 	}
...
// 	sealfsArgs := []string{"--log-level", "warn", "create", "-m", params[paramServer], volumeName, "100000"}
// 	mountArgsLogStr := ""
...
// 	onDelete := params[paramOnDelete]
// 	if onDelete == "" {
// 		onDelete = defaultOnDeletePolicy
// 	}
